    ...
    beforeEach(module(function ($provide) {
        $provide.factory('getData', function () {
            getDataMock = sinon.stub({
                ...
                data: [{
                    "id": "5593aaa04d6f63617a4e1200",
                    "jobName": "Nurse Practicioner",
                    "type": "Developer",
                    "details": {
                        "employer": "Zazio",
                        "numberOfVacencies": 43,
                        "experianceLevel": "CEO",
                        "qualification": "MBA",
                        "experianceYears": 12,
                        "PostedDate": "11/03/2015",
                        "LastDateOfApplication": "20/08/2015"
                    }
                }, {
                    "id": "5593aaa04d6f63617a4f1200",
                    ...
                    "details": {
                        ...
                        "qualification": "B.com",
                        "experianceYears": 14,
                        "PostedDate": "07/04/2015",
                        "LastDateOfApplication": "02/08/2015"
                    }
                }],
                images: [{
                    name: "Developer",
